...
plt.bar(x_base, height=weights[0: recep_field], width=0.5)
plt.bar(x_base + 0.5, height=weights[recep_field: recep_field * 2], width=0.5)
plt.legend(['PR reward / cost', 'FR reward / cost'], fontsize=30)
